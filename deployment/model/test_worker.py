from deployment.model.video2world_worker import (
    Video2World_Validator,
    Video2World_Worker,
)
from deployment.model.text2image_worker import Text2Image_Validator, Text2Image_Worker
...
def test_video2world():
    ...
    pipeline = Video2World_Worker(
        num_gpus=1, checkpoint_dir=global_env.checkpoint_dir, model_size="2p5B"
    )
...
def test_text2image():
    ...
    pipeline = Text2Image_Worker(num_gpus=1, checkpoint_dir=global_env.checkpoint_dir)
...
if __name__ == "__main__":
    ...
    if global_env.model_name == "video2world":
        test_video2world()
    elif global_env.model_name == "text2image":
        test_text2image()
